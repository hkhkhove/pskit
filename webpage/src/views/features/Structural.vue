...
<template>
    <TaskLayout title="Structural Feature Extraction" :processing="isLoading" :errorMessage="submissionError" :isTaskView="is_task_view" :isResultsView="is_results_view" :hasResults="showResults" @submit="handleSubmit">
        <template #input>
